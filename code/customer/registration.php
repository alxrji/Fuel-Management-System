...
if (isset($_POST['submit'])) {
  ...
  if ($rsltcheck == 0) {
    ...
    if ($reg_query) {
      ...
      $user_reg = "INSERT INTO `user`(`log_id`, `fname`, `lname`, `email`, `phone`, `addresss`, `place`) VALUES ('$logid','$fname','$lname','$email','$phone','$addresss', '$place')";
    ...
    <div class="container-FLUID py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-lg-8 col-xl-6">
          ...
          <img src="../images/reg.jpg" class="w-100 img-fluid" style="border-top-left-radius: .3rem; border-top-right-radius: .3rem;" alt="Sample photo">

            <hr style="height:20px;" />
            <center>
              <h1 class="heading color-black"> CUSTOMER REGISTER </h1>
            </center>
              ...
              <form action="" method="POST" name="rentform" class="wow fadeInUp" data-wow-delay="0.6s" onsubmit="return validate()">
                <center>
                  <div class="col-md-8 col-sm-6">
                    ...
                    <br>
                    <div class="row">
                      <input type="text" class="form-control" placeholder="Email" name="email" id="email" onkeyup="return validate()" required><br>
                    </div>
                    <span id="msg3" style="color:red"></span>
                    <br>
                    <div class="row">
                      <input type="text" class="form-control" placeholder="Phone number" name="phone" id="phone" onkeyup="return validate()" required minlength="10" maxlength="10" required pattern="[0-9]+"><br>
                      <span id="msg4" style="color:red"></span>
                    </div><br>
                    <div class="row">
                      <input type="text area" class="form-control" placeholder="House name" name="addresss" required><br>
                    </div><br>
                    <div class="row">
                    ...
                    <div class="row">
                      <input type="password" class="form-control" placeholder="Confirm password" name="cpassword" id="cpassword" onkeyup="return validate()" required><br>
