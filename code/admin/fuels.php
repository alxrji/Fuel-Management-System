        ...
        <div class="section__content section__content--p30">
          <div class="container-fluid">
            <div class="row">
              ...
              <form class="d-flex justify-content-center"action="fuelupdate.php" method="POST">
                ...
                <div class="form-group" style="margin-left: 10%;">
                  ...
                  <input id="cc-pament" placeholder="Enter Today's fuel price" name="fuel-price" type="text" class="form-control" aria-required="true" aria-invalid="false">
                  <button type="submit" class="btn btn-primary" style="margin-top: -28%; margin-left: 105%;" name="submit" value="submit"ss>Update</button>
              </form>
            </div>
