...
<head>
<link rel="icon" href="images/fuel.png">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="fuelstation/registration.php" class="">FUEL STATION REG</a></li>

					<li><a href="customer/registration.php" class="smoothScroll">CUSTOMER REG</a></li>
...
================================================== -->
	<div id="home">
		<div class="site-slider">
			<ul class="bxslider">
				<li>
					<img src="images/slider/thumb1 (2).jpg" alt="slider image 1">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
			...
			================================================== -->
				<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
					<div class="section-title">
						<h5 class="wow bounceIn">ALL ABOUT</h5>
						<h1 class="heading color-white">QUALITY</h1>
						<hr>
						<p class="color-white"></p>
					</div>
				</div>
				...
				<div class="col-md-6 col-sm-12">
					<h3 class="color-white">FUEL MANAGEMENT</h3>
					<h2></h2>
