...
<hr style="height:20px;"/>
          <center><h1 class="heading color-black"> FUEL STATION REGISTER </h1></center>

<div>
<form action="" method="POST" name="rentform" class="wow fadeInUp" data-wow-delay="0.6s"  onsubmit="return validate()">
    <center>
    <div class="col-md-8 col-sm-6">
            <input type="text" class="form-control" placeholder="Pump Name" name="fname" id="fname"  onkeyup="return validate()" required pattern="[A-Za-z_]+"><br>
            <span id="msg1" style="color:red"></span>  
            <input type="text" class="form-control" placeholder="Pump No" name="lname" id="lname" onkeyup="return validate()" required pattern="[A-Za-z_]+"><br>
            ...
            <input type="text area" class="form-control" placeholder="Pump owner Name" name="addresss" required><br>
